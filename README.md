...
## Test
    ...
    node tests/vocab.test.js
    node tests/report.test.js

All eight must pass before any commit. The tests cover the pure game core, all
...
prompt policy, personal-vocabulary intake, and exported-log validation.
